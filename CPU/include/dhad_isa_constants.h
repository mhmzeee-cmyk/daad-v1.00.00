...
#define DHAD_MEM_SIZE            (1 << DHAD_ADDR_WIDTH)   /* 65536 */
...
/** أقصى حجم للبرنامج */
#define DHAD_PROG_MAX_SIZE       0xF000

/** بداية البرنامج في الذاكرة */
#define DHAD_PROG_START          0x0000

/** نهاية الذاكرة الفعلية */
#define DHAD_MEM_END             0xFFFF
 ...
 *  │ العنوان    │ الحجم    │ الوصف                                   │
 *  ├────────────┼──────────┼─────────────────────────────────────────┤
 *  │ 0xFFFF     │ 1        │ نهاية الذاكرة                           │
 *  │ ...        │ ...      │ ...                                     │
 *  │ 0x0000     │ 0xF000   │ منطقة البرنامج + البيانات               │
 *  │ ...        │ ...      │ ...                                     │
 *  │ 0x000      │          │ بداية الذاكرة                           │
 *  └─────────────────────────────────────────────────────────────────┘
 * ═══════════════════════════════════════════════════════════════════════════════ */
...
#define DHAD_MEM_PROG_START     0x0000

/** نهاية منطقة البرنامج */
#define DHAD_MEM_PROG_END       0xEFFF
 ...
 *  │ PC       │ عداد البرنامج (16-bit، غير مرئي للمبرمج)       │
 *  │ SP       │ مؤشر المكدس (5-bit، غير مرئي للمبرمج)          │
 *  └────────────────────────────────────────────────────────────┘
 * ═══════════════════════════════════════════════════════════════════════════════ */
...
typedef enum {
    ...
    DHAD_REG_PC,        /* عداد البرنامج (16-bit) */
    DHAD_REG_SP,        /* مؤشر المكدس (5-bit) */
...
#define DHAD_INST_SIZE_LDRI     4   /* اقرأ غير مباشر: 4 بايت */
#define DHAD_INST_SIZE_STRI     4   /* اكتب غير مباشر: 4 بايت */
...
#define DHAD_EXT_CMP           0xE0    /* قارن سج: مح - سج (الأعلام فقط) — Phase 12.5: uses 0xE0-0xE7 */
#define DHAD_EXT_EI            0xF3    /* فعّل المقاطعات — Phase 12.5: relocated from 0xE1 */
#define DHAD_EXT_DI            0xF4    /* عطّل المقاطعات — Phase 12.5: relocated from 0xE2 */
#define DHAD_EXT_RETI          0xF5    /* العودة من المقاطعة — Phase 12.5: relocated from 0xE3 */

/* ─── العنونة غير المباشرة (Phase 12.4) ─── */
#define DHAD_EXT_LDRI          0xF1    /* اقرأ غير مباشر: dst = mem[(hi<<8)|lo] */
#define DHAD_EXT_STRI          0xF2    /* اكتب غير مباشر: mem[(hi<<8)|lo] = src */
...
#define DHAD_MNEMONIC_LDRI      "اقرأ_غيرمباشر"
#define DHAD_MNEMONIC_STRI      "خزن_غيرمباشر"
...
/** القيم القصوى */
#define DHAD_MAX_4BIT           0x0F    /* 15 — 4-bit */
 ...
 *  ║  عنوان 16-bit │ 0x0000-0xFFFF   │ بايتان little-endian          ║
 *  ╚═══════════════════════════════════════════════════════════════════╝
 *
