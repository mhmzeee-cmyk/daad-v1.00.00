@echo off
REM ============================================================
REM  validate-windows10.bat — قبول Windows 10 الحقيقي (يُشغَّل على الجهاز فقط)
...
echo ========================================
echo  Dhad Studio — Windows 10 Acceptance
echo ========================================
echo.
...
echo ========================================
if %FAIL%==0 (
  echo  RESULT: PASS — Windows 10 VERIFIED
) else (
...
"%DIR%%EXE%" > "%TEMP%\dhad_val10.txt" 2>&1
set CODE=!ERRORLEVEL!
findstr /C:"%MARK%" "%TEMP%\dhad_val10.txt" >nul 2>&1
if errorlevel 1 (
