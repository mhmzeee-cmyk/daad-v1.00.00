...
enum class KeywordType {
    ...
    KwContinue,      // استمر
    KwGoto,          // انتقل
    KwX,             // س (محور الإحداثيات)
    KwY,             // ص (محور الإحداثيات)
    ...
    // 8b. منطق عربي — يتوافق مع Web
    KwAndArabic,     // و
    KwOrArabic,      // أو

    // 9. معالجة الصور (20) — يتوافق مع Web
    KwLoadImage,     // حمّل_صورة
    KwDrawImage,     // ارسم_صورة
    KwImageSize,     // حجم_صورة
    KwSaveImage,     // احفظ_صورة
    KwCropImage,     // قص_صورة
    KwResize,        // غيّر_حجم
    KwRotateImage,   // لف_صورة
    KwFlipImage,     // قلب_صورة
    KwOpacity,       // شفافية
    KwFilter,        // فلتر
    KwOverlay,       // تراكب
    KwBackground,    // خلفية
    ...
    KwCircle,        // دائرة
    KwLine,          // خط
    KwTextOnCanvas,  // نص_على_لوحة
    KwClear          // مسح
};

constexpr int KW_TOTAL_COUNT = 103; // 80 base + 1 print + 2 arabic logic + 20 image processing
